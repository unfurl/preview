...
(async function build() {
  ...
  const es5files = [
    './dist/apps/components/runtime-es5.js',
    './dist/apps/components/polyfills-es5.js',
    // './dist/apps/components/scripts-es2015.js',
    './dist/apps/components/main-es5.js'
  ];
  await fs.ensureDir('elements');
  await concat(es5files, 'elements/elements.js');
  await fs.copyFile('./dist/apps/components/styles.css', 'elements/styles.css');
